...
function program5(depth0,data) {
  ...
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.registered), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  ...
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.registered), {hash:{},inverse:self.noop,fn:self.program(3, program3, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n    ";
  stack1 = helpers.unless.call(depth0, (depth0 && depth0.registered), {hash:{},inverse:self.noop,fn:self.program(5, program5, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n</article>\n";
  return buffer;
  }),
